...
public class SelectMorePop_my extends BasePopup {
    ...
    public SelectMorePop_my(Activity activity, SelectCallBack callBack) {
        super(activity, R.layout.pop_select_more_my);
