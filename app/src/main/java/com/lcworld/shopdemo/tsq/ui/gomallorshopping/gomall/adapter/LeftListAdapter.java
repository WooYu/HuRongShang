package com.lcworld.shopdemo.tsq.ui.gomallorshopping.gomall.adapter;
    ...
    private class Holder {
        ...
        public void updataView(final int position) {
            ...
            if (flagArray[position]) {
                left_list_item.setTextColor(context.getResources().getColor(R.color.theme_tsq_market));
            } else {
                left_list_item.setTextColor(context.getResources().getColor(R.color.black_666666));
            }
        }
